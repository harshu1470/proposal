...
if(val === 'Yes' || val==="yes" || val ==="yEs" || val==="YeS" || val==="yEs"){
   ...
   btn.innerHTML = "You are Taken.You are lying.You cannot register";
}
else {
...
document.getElementById("ans2").style.display ="none";
     document.getElementById("result").innerHTML = "Lets Love each other . Happy love life to us";
 }

 else {
     alert("I know you are not please again fill the form ");
 }
}
